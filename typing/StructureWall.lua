...
---@field destroy fun(self:StructureWall):(OK|ERR_NOT_OWNER|ERR_BUSY)
...
---@field notifyWhenAttacked fun(self:StructureWall,enabled:boolean):(OK|ERR_NOT_OWNER|ERR_INVALID_ARGS)
local StructureWall = {}
