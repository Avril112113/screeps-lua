...
--- <h2 class="api-property api-property--method" id="RawMemory.get"><span class="api-property__name">RawMemory.get</span><span class="api-property__args">()</span><div class="api-property__cpu api-property__cpu--0" title="This method has insignificant CPU cost."></div></h2> <p>Get a raw string representation of the <code>Memory</code> object.</p>
---@field get fun(self:RawMemory)
--- <h2 class="api-property api-property--method" id="RawMemory.set"><span class="api-property__name">RawMemory.set</span><span class="api-property__args">(value)</span><div class="api-property__cpu api-property__cpu--0" title="This method has insignificant CPU cost."></div></h2> <p>Set new <code>Memory</code> value.</p>
---@field set fun(self:RawMemory,value:string)
--- <h2 class="api-property api-property--method" id="RawMemory.setActiveSegments"><span class="api-property__name">RawMemory.setActiveSegments</span><span class="api-property__args">(ids)</span><div class="api-property__cpu api-property__cpu--0" title="This method has insignificant CPU cost."></div></h2> <p>Request memory segments using the list of their IDs. Memory segments will become available on the next tick in <a href="https://docs.screeps.com/api/#RawMemory.segments"><code>segments</code></a> object.</p>
---@field setActiveSegments fun(self:RawMemory,ids:any[])
--- <h2 class="api-property api-property--method" id="RawMemory.setActiveForeignSegment"><span class="api-property__name">RawMemory.setActiveForeignSegment</span><span class="api-property__args">(username, [id])</span><div class="api-property__cpu api-property__cpu--0" title="This method has insignificant CPU cost."></div></h2> <p>Request a memory segment of another user. The segment should be marked by its owner as public using <a href="https://docs.screeps.com/api/#RawMemory.setPublicSegments"><code>setPublicSegments</code></a>. The segment data will become available on the next tick in <a href="https://docs.screeps.com/api/#RawMemory.foreignSegment"><code>foreignSegment</code></a> object. You can only have access to one foreign segment at the same time.   </p>
---@field setActiveForeignSegment fun(self:RawMemory,username:string|nil,id:any?)
--- <h2 class="api-property api-property--method" id="RawMemory.setDefaultPublicSegment"><span class="api-property__name">RawMemory.setDefaultPublicSegment</span><span class="api-property__args">(id)</span><div class="api-property__cpu api-property__cpu--0" title="This method has insignificant CPU cost."></div></h2> <p>Set the specified segment as your default public segment. It will be returned if no <code>id</code> parameter is passed to <a href="https://docs.screeps.com/api/#RawMemory.setActiveForeignSegment"><code>setActiveForeignSegment</code></a> by another user.   </p>
---@field setDefaultPublicSegment fun(self:RawMemory,id:number|nil)
--- <h2 class="api-property api-property--method" id="RawMemory.setPublicSegments"><span class="api-property__name">RawMemory.setPublicSegments</span><span class="api-property__args">(ids)</span><div class="api-property__cpu api-property__cpu--0" title="This method has insignificant CPU cost."></div></h2> <p>Set specified segments as public. Other users will be able to request access to them using <a href="https://docs.screeps.com/api/#RawMemory.setActiveForeignSegment"><code>setActiveForeignSegment</code></a>.     </p>
