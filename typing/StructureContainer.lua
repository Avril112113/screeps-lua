...
---@field destroy fun(self:StructureContainer):(OK|ERR_NOT_OWNER|ERR_BUSY)
...
---@field notifyWhenAttacked fun(self:StructureContainer,enabled:boolean):(OK|ERR_NOT_OWNER|ERR_INVALID_ARGS)
