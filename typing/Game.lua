...
---@field getHistory fun(self:Game.market,resourceType:any?):(RoomObject[]|{resourceType:string,date:string,transactions:integer,volume:integer,avgPrice:number,stddevPrice:number}[])
--- ![1](imgs/cpu_1.png) - Low CPU cost.
