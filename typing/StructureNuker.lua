...
--- <p>Launch a nuke to the specified position.</p> <table><thead><tr><th>parameter</th><th>type</th><th>description</th></tr></thead><tbody><tr><td><code>pos</code></td><td><a href="https://docs.screeps.com/api/#RoomPosition">RoomPosition</a></td><td><p>The target room position.</p></td></tr></tbody></table>
---@field launchNuke fun(pos:any)
