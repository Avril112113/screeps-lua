var Module = (() => {
	...
	return function (Module) {
		...
		["_init", "_loop", "_eval", "_fflush", "___getTypeName", "__embind_initialize_bindings", "onRuntimeInitialized"].forEach((prop) => {
		...
		var wasmBinaryFile;
		wasmBinaryFile = "lua_module.wasm";
		...
		var _init = (Module["_init"] = createExportWrapper("init", asm));
		var _loop = (Module["_loop"] = createExportWrapper("loop", asm));
		var _eval = (Module["_eval"] = createExportWrapper("eval", asm));
